...
* Inside the `html-bio-with-css` folder, use the command line to make a folder called `css`.
* Inside the `css` folder, use the command line to make a file called `style.css`
...
* Style the example on the demo image.
